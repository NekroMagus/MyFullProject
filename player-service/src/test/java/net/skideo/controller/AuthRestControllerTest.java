...
public class AuthRestControllerTest {
    ...
    Logger logger = Logger.getLogger(AuthRestControllerTest.class.getName());
    ...
    public void authenticateTest() throws Exception {
        userService.create(new UserRegistrationDto("egor","12341234",RolePeople.PROFESSIONAL,true));
