...
public enum RoleFootball {
    ...
    RF, //RF (ПН) - Right Forward ( правый оттянутый форвард )
    CF, //CF (СН) - Central Forward ( центральный оттянутый форвард )
    LF, //LF (ЛН) - Left Forward ( левый оттянутый форвард )
